namespace StockAnalyzer
{
    public class TestData
    {
        ...
        public static string TestStringEarningData()
        {
             return @"<table id=""earningsCalendarData"" class=""genTbl closedTbl ecoCalTbl earnings persistArea js-earnings-table"" tablesorter="""">
<thead>
<tr>
<th></th>
